...
file_type_t::get_supported() {
...
#endif
  s_supported_file_types.emplace_back(file_type_e::flv,         Y("FLV (Flash Video)"),                               "flv f4v");
  ...
  s_supported_file_types.emplace_back(file_type_e::matroska,    Y("Matroska audio/video files"),                      "mka mks mkv mk3d webm weba webmv webma");
