...
//ms_available_translations.emplace_back("are", "ar_AE",       "ar",          "arabic",     "Arabic",                         "اَلْعَرَبِيَّةُ",             false, 0x0001, 0x0e);
  ...
  ms_available_translations.emplace_back("ces", "cs_CZ",       "cs",          "czech",      "Czech",                          "Čeština",             false, 0x0005, 0x00);
  ms_available_translations.emplace_back("deu", "de_DE",       "de",          "german",     "German",                         "Deutsch",             false, 0x0007, 0x00);
  ms_available_translations.emplace_back("eus", "eu_ES",       "eu",          "basque",     "Basque",                         "Euskara",             false, 0x002d, 0x00);
//ms_available_translations.emplace_back("fas", "fa_IR",       "fa",          "persian",    "Persian",                        "فارسی",               false, 0x0029, 0x00);
  ms_available_translations.emplace_back("fra", "fr_FR",       "fr",          "french",     "French",                         "Français",            false, 0x000c, 0x00);
...
//ms_available_translations.emplace_back("hun", "hu_HU",       "hu",          "hungarian",  "Hungarian",                      "Magyar",              false, 0x000e, 0x00);
  ...
  ms_available_translations.emplace_back("nld", "nl_NL",       "nl",          "dutch",      "Dutch",                          "Nederlands",          false, 0x0013, 0x00);
  ...
  ms_available_translations.emplace_back("ron", "ro_RO",       "ro",          "romanian",   "Romanian",                       "Română",              false, 0x0018, 0x00);
...
//ms_available_translations.emplace_back("vie", "vi_VN",       "vi",          "vietnamese", "Vietnamese",                     "Tiếng Việt",          false, 0x002a, 0x00);
  ms_available_translations.emplace_back("zho", "zh_CN",       "zh_CN",       "chinese",    "Chinese (Simplified)",           "中文 (简体)",         true,  0x0004, 0x02);
  ms_available_translations.emplace_back("zho", "zh_SG",       "zh_SG",       "chinese",    "Chinese (Singapore & Malaysia)", "中文 (新马简体)",     true,  0x1004, 0x04);
  ms_available_translations.emplace_back("zho", "zh_TW",       "zh_TW",       "chinese",    "Chinese (Traditional)",          "中文 (繁體)",         true,  0x7C04, 0x01);
#endif
